/**
 * This file is for the timing experiments for the gastner newman algorithm.
 */
    ...
    */
    ...
    cart_makecart(pointx, pointy, npoints, xsize, ysize, blur) {
        ...
        while(this.drp>0) {
            ...
            var thisLoopData = [timeToTransform,preambleTime,inverseTransformTime,velocityTime,reboundsTime];
            data.push(thisLoopData);
        }
    ...
    cart_twosteps(pointx,pointy,npoints,t,h,s,xsize,ysize) {
        ...
        //Calculate density of each grid square
        //INVERSE TRANSFORM - iDCT on the grid and calculate the new density
        var t1 = new Date().getTime();
        ...
        var t2 = new Date().getTime();
        inverseTransformTime = t2-t1;
        /////////////////////////////////////////////////////////////////

        //Velocity grid calculation
        //calculate the rate of change in direction for each grid square
        var t1 = new Date().getTime();
        ...
        this.spp = s4;
        return [pointx,pointy,inverseTransformTime,velocityTime,reboundsTime];
    }
